...
public class DBManager {
    ...
    public static void initialize(){
        ...
        transactionActions.addToTransactions(new Transaction(transactionsDB.getNextID(), "02/02/21", account1, "Tims", -5.50));
        transactionActions.addToTransactions(new Transaction(transactionsDB.getNextID(), "05/03/21", account2, "Money", -45.00));
    }
